...
const Header: React.FC = () => {
  ...
  return (
    <div className=" top-0 w-full h-20 z-[49] bg-white px-6 lg:px-4 flex  items-center shadow-md text-sm rounded">
      ...
      <TrendingUpIcon className="text-orange-500 w-6 h-6 cursor-pointer" onClick={handleTrendingUpIconClick} />
      <FileTextIcon className="w-6 h-6 cursor-pointer" onClick={handleFileTextIconClick} />
      </div>
    </div>
  );
};
